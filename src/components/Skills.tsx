...
const Skills: React.FC = () => {
    ...
    const getSkillIcon = (skillName: string) => {
        ...
        const iconMap: Record<string, { icon: IconComponent; color: string } | { image: string; alt: string }> = {
            'C': { image: '/public/Skills_Images/C_logo.png', alt: 'C' },
            'C++': { image: '/public/Skills_Images/CPP_logo.png', alt: 'C++' },
            'Java': { image: '/public/Skills_Images/Java_logo.png', alt: 'Java' },
            'Python': { image: '/public/Skills_Images/Python_logo.png', alt: 'Python' },
            ...
            'Tailwind CSS': { image: '/public/Skills_Images/Tailwind-CSS_logo.png', alt: 'Tailwind CSS' },
            'Framer Motion': { image: '/public/Skills_Images/Framer-Motion_logo.png', alt: 'Framer Motion' },
            'Vite': { image: '/public/Skills_Images/Vite.js_logo.png', alt: 'Vite' },
            'Node.js': { image: '/public/Skills_Images/Node.js_logo.png', alt: 'Node.js' },
            'Flask': { icon: SiFlask, color: '#000000' },
            'FastAPI': { icon: SiFastapi, color: '#009688' },
            'MySQL': { image: '/public/Skills_Images/MySQL_Logo.png', alt: 'MySQL' },
            'MongoDB': { image: '/public/Skills_Images/MongoDB_logo.png', alt: 'MongoDB' },
            'SQLite': { image: '/public/Skills_Images/SQLite_logo.png', alt: 'SQLite' },
            'Firebase': { image: '/public/Skills_Images/Firebase_logo.png', alt: 'Firebase' },
            'NumPy': { image: '/public/Skills_Images/NumPy_logo.png', alt: 'NumPy' },
            'Pandas': { image: '/public/Skills_Images/Pandas_logo.png', alt: 'Pandas' },
            'Matplotlib': { image: '/public/Skills_Images/Matplotlib_logo.png', alt: 'Matplotlib' },
            'Seaborn': { image: '/public/Skills_Images/Seaborn_logo.png', alt: 'Seaborn' },
            'Plotly': { image: '/public/Skills_Images/Plotly_logo.png', alt: 'Plotly' },
            'Scikit-learn': { image: '/public/Skills_Images/Scikit-learn_logo.png', alt: 'Scikit-learn' },
            'XGBoost': { image: '/public/Skills_Images/XGBoost_logo.png', alt: 'XGBoost' },
            'TensorFlow': { image: '/public/Skills_Images/TensorFlow_logo.png', alt: 'TensorFlow' },
            'Amazon Web Services': { image: '/public/Skills_Images/AWS_logo.png', alt: 'Amazon Web Services' },
            'Microsoft Azure': { image: '/public/Skills_Images/Azure_logo.png', alt: 'Microsoft Azure' },
            'Google Cloud': { image: '/public/Skills_Images/Google-Cloud_logo.png', alt: 'Google Cloud' },
            'Docker': { image: '/public/Skills_Images/Docker_logo.png', alt: 'Docker' },
            'Linux': { image: '/public/Skills_Images/Linux_logo.png', alt: 'Linux' },
            'Vercel': { icon: SiVercel, color: '#000000' },
            'Netlify': { image: '/public/Skills_Images/Netlify_logo.png', alt: 'Netlify' },
            'Streamlit': { image: '/public/Skills_Images/Streamlit_logo.png', alt: 'Streamlit' },
            'Git': { icon: SiGit, color: '#F05032' },
            'GitHub': { icon: SiGithub, color: '#181717' },
            'Visual Studio Code': { image: "/public/Skills_Images/VS-Code_logo.png", alt: 'Visual Studio Code' },
            'Antigravity': { image: '/public/Skills_Images/Antigravity_logo.png', alt: 'Antigravity'},
            'LeetCode': { image: '/public/Platforms_Images/LeetCode_logo.png', alt: 'LeetCode' },
            'Codolio': { image: '/public/Platforms_Images/Codolio_logo.GIF', alt: 'Codolio' },
            'HackerRank': { image: '/public/Platforms_Images/HackerRank_logo.png', alt: 'HackerRank' },
        };
        ...
        if ('image' in iconConfig) {
            const imageClassName = skillName === 'XGBoost' || skillName === 'Netlify' || skillName === 'MySQL' || skillName === 'Java' || skillName === 'Python'
                ? 'h-full w-full object-cover drop-shadow-sm'
    ...
    const skillCategories: Record<string, string[]> = {
        ...
        'Tools': ['Git', 'GitHub', 'Visual Studio Code', 'Antigravity'],
    };
