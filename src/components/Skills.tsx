...
const Skills: React.FC = () => {
    ...
    const getSkillIcon = (skillName: string) => {
        ...
        const iconMap: Record<string, { icon: IconComponent; color: string } | { image: string; alt: string }> = {
            'C': { image: '/Skills_Images/C_logo.webp', alt: 'C' },
            'C++': { image: '/Skills_Images/CPP_logo.webp', alt: 'C++' },
            'Java': { image: '/Skills_Images/Java_logo.webp', alt: 'Java' },
            'Python': { image: '/Skills_Images/Python_logo.webp', alt: 'Python' },
            ...
            'Tailwind CSS': { image: '/Skills_Images/Tailwind-CSS_logo.webp', alt: 'Tailwind CSS' },
            'Framer Motion': { image: '/Skills_Images/Framer-Motion_logo.webp', alt: 'Framer Motion' },
            'Vite': { image: '/Skills_Images/Vite.js_logo.webp', alt: 'Vite' },
            ...
            'NumPy': { image: '/Skills_Images/NumPy_logo.webp', alt: 'NumPy' },
            'Pandas': { image: '/Skills_Images/Pandas_logo.webp', alt: 'Pandas' },
            'Matplotlib': { image: '/Skills_Images/Matplotlib_logo.webp', alt: 'Matplotlib' },
            'Seaborn': { image: '/Skills_Images/Seaborn_logo.webp', alt: 'Seaborn' },
            'Plotly': { image: '/Skills_Images/Plotly_logo.webp', alt: 'Plotly' },
            'Scikit-learn': { image: '/Skills_Images/Scikit-learn_logo.webp', alt: 'Scikit-learn' },
            'XGBoost': { image: '/Skills_Images/XGBoost_logo.webp', alt: 'XGBoost' },
            'TensorFlow': { image: '/Skills_Images/TensorFlow_logo.webp', alt: 'TensorFlow' },
            'Amazon Web Services': { image: '/Skills_Images/AWS_logo.webp', alt: 'Amazon Web Services' },
            'Microsoft Azure': { image: '/Skills_Images/Azure_logo.webp', alt: 'Microsoft Azure' },
            'Google Cloud': { image: '/Skills_Images/Google-Cloud_logo.webp', alt: 'Google Cloud' },
            'Docker': { image: '/Skills_Images/Docker_logo.webp', alt: 'Docker' },
            'Linux': { image: '/Skills_Images/Linux_logo.webp', alt: 'Linux' },
            'Vercel': { icon: SiVercel, color: '#000000' },
            'Netlify': { image: '/Skills_Images/Netlify_logo.webp', alt: 'Netlify' },
            'Streamlit': { image: '/Skills_Images/Streamlit_logo.webp', alt: 'Streamlit' },
