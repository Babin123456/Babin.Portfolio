...
const Skills: React.FC = () => {
    ...
    const getSkillIcon = (skillName: string) => {
        ...
        const iconMap: Record<string, { icon: IconComponent; color: string } | { image: string; alt: string }> = {
            'C': { image: '/Skills_Images/C_logo.png', alt: 'C' },
            'C++': { image: '/Skills_Images/CPP_logo.png', alt: 'C++' },
            'Java': { image: '/Skills_Images/Java_logo.png', alt: 'Java' },
            'Python': { image: '/Skills_Images/Python_logo.png', alt: 'Python' },
            ...
            'Tailwind CSS': { image: '/Skills_Images/Tailwind-CSS_logo.png', alt: 'Tailwind CSS' },
            'Framer Motion': { image: '/Skills_Images/Framer-Motion_logo.png', alt: 'Framer Motion' },
            'Vite': { image: '/Skills_Images/Vite.js_logo.png', alt: 'Vite' },
            'Node.js': { image: '/Skills_Images/Node.js_logo.png', alt: 'Node.js' },
            'Flask': { icon: SiFlask, color: '#000000' },
            'FastAPI': { icon: SiFastapi, color: '#009688' },
            'MySQL': { image: '/Skills_Images/MySQL_Logo.png', alt: 'MySQL' },
            'MongoDB': { image: '/Skills_Images/MongoDB_logo.png', alt: 'MongoDB' },
            'SQLite': { image: '/Skills_Images/SQLite_logo.png', alt: 'SQLite' },
            'Firebase': { image: '/Skills_Images/Firebase_logo.png', alt: 'Firebase' },
            'NumPy': { image: '/Skills_Images/NumPy_logo.png', alt: 'NumPy' },
            'Pandas': { image: '/Skills_Images/Pandas_logo.png', alt: 'Pandas' },
            'Matplotlib': { image: '/Skills_Images/Matplotlib_logo.png', alt: 'Matplotlib' },
            'Seaborn': { image: '/Skills_Images/Seaborn_logo.png', alt: 'Seaborn' },
            'Plotly': { image: '/Skills_Images/Plotly_logo.png', alt: 'Plotly' },
            'Scikit-learn': { image: '/Skills_Images/Scikit-learn_logo.png', alt: 'Scikit-learn' },
            'XGBoost': { image: '/Skills_Images/XGBoost_logo.png', alt: 'XGBoost' },
            'TensorFlow': { image: '/Skills_Images/TensorFlow_logo.png', alt: 'TensorFlow' },
            'Amazon Web Services': { image: '/Skills_Images/AWS_logo.png', alt: 'Amazon Web Services' },
            'Microsoft Azure': { image: '/Skills_Images/Azure_logo.png', alt: 'Microsoft Azure' },
            'Google Cloud': { image: '/Skills_Images/Google-Cloud_logo.png', alt: 'Google Cloud' },
            'Docker': { image: '/Skills_Images/Docker_logo.png', alt: 'Docker' },
            'Linux': { image: '/Skills_Images/Linux_logo.png', alt: 'Linux' },
            'Vercel': { icon: SiVercel, color: '#000000' },
            'Netlify': { image: '/Skills_Images/Netlify_logo.png', alt: 'Netlify' },
            'Streamlit': { image: '/Skills_Images/Streamlit_logo.png', alt: 'Streamlit' },
            'Git': { icon: SiGit, color: '#F05032' },
            'GitHub': { icon: SiGithub, color: '#181717' },
            'Visual Studio Code': { image: "/Skills_Images/VS-Code_logo.png", alt: 'Visual Studio Code' },
            'Antigravity': { image: '/Skills_Images/Antigravity_logo.png', alt: 'Antigravity'},
            'LeetCode': { image: '/Platforms_Images/LeetCode_logo.png', alt: 'LeetCode' },
            'Codolio': { image: '/Platforms_Images/Codolio_logo.GIF', alt: 'Codolio' },
            'HackerRank': { image: '/Platforms_Images/HackerRank_logo.png', alt: 'HackerRank' },
        };
