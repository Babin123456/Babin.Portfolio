  ...
  switch (variant) {
    case "circle":
      return [
        ...
        `circle(${toRadius(maxRadius * 1.08)} at ${point(cx, cy)})`,
      ]
    case "square": {
...
export const AnimatedThemeToggler = ({
      ...
      ready
        .then(() => {
          const anim = document.documentElement.animate(
            ...
            {
              duration,
              // Material 3 emphasized curve for ultra-smooth 120fps cinematic circle expansion
              easing:
                shape === "circle"
  ...
  return (
    <button
      ...
      {...props}
    >
      {children ? children : isDark ? <Sun /> : <Moon />}
