 ...
 * - "Bootcamps | Events | Competitions" → Shows Hackathons & Events, Let's Upgrade, Unstop, MyBharat, myGov, Hack2Skill, Kaggle, Skill India, IndiaAI
 * - "Internship Certificates" → Shows Oasis Infobyte
 * - "Badges | Trophies" → Shows Google Badges, Holopin Badges, Microsoft Badges, Microsoft Trophies, HP Life Badges and all other badges from various platforms
 * 
 * ORGANIZATION:
...
export const achievementsData: AchievementCategory[] = [
    ...
    // ==================== BOOTCAMPS | EVENTS | COMPETITIONS ====================
    {
        ...
        items: [
            { title: "ACM Industry Day 2026", file: "/Achievements/ACM_Participation_Certificate_2026.png" },
            ...
            { title: "Protex Hack-2-Win Hackathon Participation Certificate", file: "/Achievements/Events/Protex_Hack-2-Win_Hackathon.png"},
        ]
    },
    {
        category: "Hack2Skill",
    ...
    },
    {
        ...
        items: [
            ...
            { title: "MongoDB Overview: Core Concepts and Architecture", file: "/Achievements/gfg/MongoDB_Overview_Core_Concepts_and_Architecture.png" },
            { title: "From Relational Model (SQL) to MongoDB's Document Model", file: "/Achievements/gfg/From_Relational_Model_(SQL)_to_MongoDB's_Document_Model.png" },
            { title: "MongoDB Schema Design Patterns and Anti-patterns Skill", file: "/Achievements/gfg/MongoDB_Schema_Design_Patterns_and_Anti-patterns_Skill_Badge.png" },
            { title: "Building AI-Powered Search with MongoDB Vector Search", file: "/Achievements/gfg/Building_AI-Powered_Search_with_MongoDB_Vector_Search.png" },
            { title: "Building RAG Apps Using MongoDB", file: "/Achievements/gfg/Building_RAG_Apps_Using_MongoDB.png" },
            { title: "CRUD Operations in MongoDB", file: "/Achievements/gfg/CRUD_Operations_in_MongoDB.png" },
            { title: "MongoDB Indexing Design Fundamentals", file: "/Achievements/gfg/MongoDB_Indexing_Design_Fundamentals.png" },
        ]
    },
    {
        category: "Google",
    ...
    },
    {
        ...
        items: [
            ...
            { title: "Build & Deploy Apps with Google AI Studio & Multilingual AI Speech App with Vibe Coding", file: "/Achievements/HCL Guvi/HCL_GUVI_Certification_Build_&_Deploy_Apps_with_Google_AI_Studio_&_Multilingual_AI_Speech_App_with_Vibe_Coding.png" },
            { title: "ChatGPT for Everyone (Bengali)", file: "/Achievements/HCL Guvi/ChatGPT_for_Everyone_Bengali.png" },
            { title: "Cloud DevOps Roadmap for 2026: What to Learn Next", file: "/Achievements/HCL Guvi/Cloud_DevOps_Roadmap_for_2026--What_to_Learn_Next.png" },
            { title: "India AI Impact Buildathon", file: "/Achievements/HCL Guvi/India_AI_Impact_Buildathon.png" },
            { title: "No Code + AI: How Testing Teams Can Automate Faster in 2026", file: "/Achievements/HCL Guvi/No_Code_+_AI_How_Testing_Teams_Can_Automate_Faster_in_2026.png" },
            { title: "The Future of Full Stack Development Key Skills Needed in 2026", file: "/Achievements/HCL Guvi/The_Future_of_Full_Stack_Development_Key_Skills_Needed_in_2026.png" },
            { title: "YUVA AI for ALL", file: "/Achievements/HCL Guvi/HCL_GUVI~~Certification.png" },
            { title: "Build & Launch a Meta Ads Campaign in 90 Minutes", file: "/Achievements/HCL Guvi/Build_&_Launch_a_Meta_Ads_Campaign_in_90_Minutes.png"},
        ]
    },
    {
        category: "HP Life",
    ...
    },
    {
        ...
        items: [
            ...
            { title: "Microsoft Elevate Educator: Explorer 2025-2026", file: "/Achievements/Microsoft/Microsoft_Elevate_Educator-Explorer_2025-2026.pdf" },
        ]
    },
    {
    ...
    },
    {
        ...
        items: [
            ...
            { title: "Unstop Prediction League Match 12 Participation Certificate", file: "/Achievements/Unstop/Unstop_Prediction_League_Match_12_Participation_Certificate.pdf" },
            { title: "Unstop Prediction League Match 13 Participation Certificate", file: "/Achievements/Unstop/Unstop_Prediction_League_Week_1-RR_vs_MI_(Match_13).pdf"},
            { title: "Unstop Prediction League Match 14 Participation Certificate", file: "/Achievements/Unstop/Unstop_Prediction_League_Week_1-DC_vs_GT_(Match_14).pdf"},
    ...
    },
    {
        ...
        items: [
            ...
            { title: "From Relational Model (SQL) to MongoDB's Document Model Badge", file: "/Achievements/gfg/from-relational-model-sql-to-mongodb-s-document-model.png" },
            { title: "MongoDB Schema Design Patterns and Anti-patterns Skill Badge", file: "/Achievements/gfg/mongodb-schema-design-patterns-and-anti-patterns-skill.png" },
            { title: "Building AI-Powered Search with MongoDB Vector Search", file: "/Achievements/gfg/building-ai-powered-search-with-mongodb-vector-sear.1.png" },
            { title: "Building RAG Apps Using MongoDB", file: "/Achievements/gfg/building-rag-apps-using-mongodb.png" },
            { title: "CRUD Operations in MongoDB", file: "/Achievements/gfg/crud-operations-in-mongodb.png" },
            { title: "MongoDB Indexing Design Fundamentals", file: "/Achievements/gfg/mongodb-indexing-design-fundamentals.png" },
    ...
    },
    {
        ...
        items: [
            { title: "AI Impact Pledge", file: "/Achievements/IndiaAI/ai-impact-pledge-badge.png" },
        ]
    },
    {
        ...
        items: [
            ...
            { title: "Microsoft Elevate Educator Explorer 2025-2026", file: "/Achievements/Microsoft/BADGES/microsoft-elevate-educator-explorer-2025-2026.png" },
    ...
    {
        category: "GirlScript Summer of Code 2026 (GSSoC) Badges",
        items: [
            { title: "AI Agents Track", file: "/Achievements/Badges/GSSoC_2026/ai.png" },
            { title: "Contributor", file: "/Achievements/Badges/GSSoC_2026/contributor.png" },
            { title: "Bounty Hunter", file: "/Achievements/Badges/GSSoC_2026/gssoc-badge-bounty_hunter.png" },
            { title: "Master Bounty", file: "/Achievements/Badges/GSSoC_2026/gssoc-badge-bounty_master.png" },
            { title: "Building Momentum", file: "/Achievements/Badges/GSSoC_2026/gssoc-badge-building_momentum.png" },
            { title: "Consistent Contributor (Week 4)", file: "/Achievements/Badges/GSSoC_2026/gssoc-badge-consistent.png" },
            { title: "Discord Verified", file: "/Achievements/Badges/GSSoC_2026/gssoc-badge-discord_verified.png" },
            { title: "Elite Contributor", file: "/Achievements/Badges/GSSoC_2026/gssoc-badge-elite.png" },
            { title: "First Step", file: "/Achievements/Badges/GSSoC_2026/gssoc-badge-first_steps.png" },
            { title: "5 PR Merge", file: "/Achievements/Badges/GSSoC_2026/gssoc-badge-getting_started.png" },
            { title: "GSSoC Champion", file: "/Achievements/Badges/GSSoC_2026/gssoc-badge-gssoc_champion.png" },
            { title: "Legendary Merge", file: "/Achievements/Badges/GSSoC_2026/gssoc-badge-legend.png" },
            { title: "Rare Merged", file: "/Achievements/Badges/GSSoC_2026/gssoc-badge-on_a_roll.png" },
            { title: "Point Scorer", file: "/Achievements/Badges/GSSoC_2026/gssoc-badge-point_scorer.png" },
            { title: "Power Contributor", file: "/Achievements/Badges/GSSoC_2026/gssoc-badge-power_contributor.png" },
            { title: "Profile Complete", file: "/Achievements/Badges/GSSoC_2026/gssoc-badge-profile_complete.png" },
            { title: "Prolific Merge", file: "/Achievements/Badges/GSSoC_2026/gssoc-badge-prolific.png" },
            { title: "Rising Star", file: "/Achievements/Badges/GSSoC_2026/gssoc-badge-rising_star.png" },
            { title: "Role Contributor", file: "/Achievements/Badges/GSSoC_2026/gssoc-badge-role_contributor.png" },
            { title: "Top 100 Rank", file: "/Achievements/Badges/GSSoC_2026/gssoc-badge-top_100.png" },
            { title: "Top 50 Rank", file: "/Achievements/Badges/GSSoC_2026/gssoc-badge-top_50.png" },
            { title: "Streak (Week 1)", file: "/Achievements/Badges/GSSoC_2026/gssoc-badge-week_one.png" },
            { title: "Open Source Track", file: "/Achievements/Badges/GSSoC_2026/open.png" }
        ]
    },
    {
        category: "Unstop Badges",
        items: [
            { title: "Unstop Coding Badge - 100", file: "/Achievements/Badges/Unstop_Coding_Badges/6597ccdf1689c_b1.png" },
            { title: "Unstop Coding Badge - 1000", file: "/Achievements/Badges/Unstop_Coding_Badges/6597ccf039e8a_b2.png" },
            { title: "Unstop Coding Badge - 2000", file: "/Achievements/Badges/Unstop_Coding_Badges/6597ccfb3d216_b3.png" },
            { title: "Unstop Coding Badge - 5000", file: "/Achievements/Badges/Unstop_Coding_Badges/6597cd085850e_b4.png" },
            { title: "Unstop Coding Badge - 7000", file: "/Achievements/Badges/Unstop_Coding_Badges/6597cd1392c57_b5.png" },
            { title: "Unstop Coding Badge - 10000", file: "/Achievements/Badges/Unstop_Coding_Badges/6597cd203ed65_b6.png" },
            { title: "Unstop Coding Badge - 20000", file: "/Achievements/Badges/Unstop_Coding_Badges/6597cd2c13913_b7.png" }
        ]
    },
    {
        category: "LeetCode Badges",
        items: [
            { title: "100 Days Badge (Animated)", file: "/Achievements/LeetCode/100_Day.gif" },
            { title: "100 Days Badge 2026", file: "/Achievements/LeetCode/100_Days_Badge_2026.png" },
            { title: "50 Days Badge", file: "/Achievements/LeetCode/50_Days_Badge.png" },
            { title: "50 Days Badge 2026", file: "/Achievements/LeetCode/50_Days_Badge_2026.png" },
            { title: "March LeetCode Badge", file: "/Achievements/LeetCode/March_LeetCode_Badge.png" },
            { title: "March LeetCode (Alternative)", file: "/Achievements/LeetCode/March_LeetCode.png" },
            { title: "April LeetCode Badge", file: "/Achievements/LeetCode/April_LeetCode_Badge.png" },
            { title: "April LeetCode (Alternative)", file: "/Achievements/LeetCode/April_LeetCode.png" },
            { title: "May LeetCode Badge (Animated)", file: "/Achievements/LeetCode/May_LeetCode_Badge.gif" },
            { title: "May LeetCode (Alternative)", file: "/Achievements/LeetCode/May_LeetCode.png" },
            { title: "Quest Architecture", file: "/Achievements/LeetCode/Quest_Architecture.gif" },
            { title: "Quest Database SQL", file: "/Achievements/LeetCode/Quest_DataBase_SQL.gif" },
            { title: "Quest Data Structure Algorithms", file: "/Achievements/LeetCode/Quest_Data_Structure_Algorithms.gif" },
            { title: "Quest Math", file: "/Achievements/LeetCode/Quest_Math.gif" }
        ]
    },
    {
